    ...
    @section('konten')
        ...
        @if (Auth::user()->role == 'admin')
            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                class="block mb-7 text-white bg-pink-400 mt-3  hover:bg-slate-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                type="button">
                Add Produk
            </button>
        @endif
                        ...
                        <tr
                            ...
                            <td class=" py-4 flex ">
                                <button type="button" data-modal-target="authentication-modal{{ $b->id }}"
                                    ...
                                    class="text-white bg-green-500 font-poppins font-light hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800  rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">Update</button>
